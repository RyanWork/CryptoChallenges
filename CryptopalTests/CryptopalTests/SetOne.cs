...
namespace CryptopalTests
{
  ...
  public class SetOne
  {
    ...
    [TestMethod]
    public void SetOneChallengeOne_HexToBase64()
    {
    ...
    [TestMethod]
    public void SetOneChallengeTwo_FixedXOR()
    {
    ...
    [TestMethod]
    public void SetOneChallengeThree_SingleByteXORCipher()
    {
    ...
    [TestMethod]
    public void SetOneChallengeFour_DetectSingleByteXORCipher()
    {
    ...
    [TestMethod]
    public void SetOneChallengeFive_RepeatingKeyXOR()
    {
    ...
    [TestMethod]
    public void SetOneChallengeSix_BreakRepeatingKeyXOR()
    {
      ...
      string cipherText = File.ReadAllText(Cryptography.CHALLENGE_SIX_FILE);
